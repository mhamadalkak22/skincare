...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    const whatsappMessage = `*Contact Form Submission*%0A%0A*Name:* ${formData.name}%0A*Email:* ${formData.email}%0A*Subject:* ${formData.subject}%0A*Message:* ${formData.message}`
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <div className="text-center mb-16 space-y-4">
            ...
            >
              Have questions about our products? We're here to help you find the perfect skincare solution.
            </motion.p>
          </div>
              ...
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@mazayaunited.com" className="text-primary hover:underline">
              ...
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+962780686156" className="text-primary hover:underline">
                      +962 78 068 6156
                    </a>
                  </div>
                </CardContent>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    <p className="text-sm text-muted-foreground">
                      Our customer service team is available during business hours to answer your questions and help you
