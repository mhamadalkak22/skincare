...
export const products: Product[] = [
  // RadiantGlow Products
  {
    id: "rg-serum-001",
    name: "Illuminating Vitamin C Serum",
    description:
      "Brighten and even skin tone with this powerful vitamin C formula. Reduces dark spots and boosts radiance for a luminous complexion.",
    detailedDescription:
      "Our hero serum combines 15% pure Vitamin C with ferulic acid and vitamin E for maximum antioxidant protection. This lightweight, fast-absorbing formula penetrates deep into skin layers to brighten, firm, and protect against environmental damage. Clinically proven to reduce dark spots by 60% in 8 weeks.",
    price: 89.0,
    brand: "topicrem",
    category: "Serums",
    image: "/pink-serum-bottle-luxury.jpg",
    benefits: ["Brightens skin tone", "Reduces dark spots", "Antioxidant protection", "Boosts collagen production"],
  },
  {
    id: "rg-moisturizer-001",
    name: "Radiance Hydrating Cream",
    description:
      "Luxurious daily moisturizer that deeply hydrates while enhancing your natural glow. Perfect for all skin types.",
    detailedDescription:
      "This velvety cream delivers 24-hour hydration with a blend of hyaluronic acid, squalane, and niacinamide. The formula locks in moisture while improving skin texture and tone. Dermatologist-tested and non-comedogenic, it leaves skin plump, dewy, and glowing without any greasy residue.",
    price: 75.0,
    brand: "topicrem",
    category: "Moisturizers",
    image: "/pink-cream-jar-elegant.jpg",
    benefits: ["24-hour hydration", "Plumping effect", "Soft matte finish", "Lightweight texture"],
  },
  {
    id: "rg-cleanser-001",
    name: "Gentle Glow Cleanser",
    description:
      "Mild foaming cleanser that removes impurities without stripping skin. Leaves face fresh, clean, and radiant.",
    detailedDescription:
      "A pH-balanced gel cleanser enriched with chamomile and green tea extracts. Creates a gentle lather that effectively removes makeup, dirt, and excess oil while maintaining skin's natural moisture barrier. Sulfate-free formula won't dry or irritate even the most sensitive skin.",
    price: 52.0,
    brand: "topicrem",
    category: "Cleansers",
    image: "/pink-cleanser-bottle.jpg",
    benefits: ["Deep cleansing action", "pH balanced formula", "Non-drying", "Gentle on sensitive skin"],
  },
  {
    id: "rg-mask-001",
